...
export default function Login() {
  ...
  const {value: passwordValue, handleInputChange: handlePasswordChange, handleInputBlur: handlePasswordBlur, hasError: passwordHasError} = useInput('', (value) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="control-row">
        ...
        value={emailValue}
        error={emailhasError && 'pls enter a valid email'}
        />
        ...
        onBlur={handlePasswordBlur}
         ...
         value={passwordValue}
         error={passwordHasError && 'pls enter a valid password'}
        />
      </div>
